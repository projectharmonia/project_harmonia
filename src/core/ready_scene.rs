...
impl Plugin for ReadyScenePlugin {
    fn build(&self, app: &mut App) {
        app.add_event::<SceneReady>().add_systems(
            PostUpdate,
...
#[derive(Event)]
pub(crate) struct SceneReady(pub(crate) Entity);
